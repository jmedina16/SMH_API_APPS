...
<html>
    <div class="pf-checkout-container pf-success-page">
        <?php if ($_GET['response_code'] == 1) { ?>
                ...
                <div class="pf-success-info">
                    <ul>
                        <li>
                            ...
                            <span id="pf-full-name" class="pf-value"><?php echo $_GET['title'] ?></span>
                        </li>
                        <li>
                            <span class="pf-value-name">Order #:</span>
                            <span id="pf-auth-code" class="pf-value"><?php echo $_GET['order_id'] ?></span>
                        </li>
                    </ul>
                </div>
            ...
            <?php if ($_GET['isMobile'] == 'true') { ?>
                <div class="modal-footer">
                    <button style="margin-left: auto; margin-right: auto; width: 112px; display: block; font-size: 15px;" type="button" class="btn btn-primary" data-dismiss="modal" onclick="Redirect('<?php echo urldecode(base64_decode($_GET['url'])) ?>');">Return to site</button>
                </div>
            <? } else { ?>
                <p class="pf-processed-msg">You may now close this window and view your content</p>
            <? } ?>
        <? } else { ?>
            <h1 class="pf-error">Error</h1>
            <div class="pf-success-details">
                <p>Sorry, an error occurred:</p>
                <div class="pf-error"><?php echo $_GET['response_reason_text'] ?></div>
