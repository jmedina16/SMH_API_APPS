...
function reset_pass($pid, $sm_ak, $reset_token, $email, $pass) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=reset_pass&pid=" . $pid . "&sm_ak=" . $sm_ak . "&reset_token=" . $reset_token . "&email=" . $email . "&pass=" . $pass);
        ...
        <script>   
            ...
            function resetPassword(){                
                ...
                if(valid){
                    ...
                    $.ajax({
                        type: "GET",
                        url: "https://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/dev.php?action=reset_pass",
                        data: sessData,
                        dataType: 'json',
                        beforeSend: function() {                    
