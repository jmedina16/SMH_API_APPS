...
function store_facebook_authorization($pid, $ks, $code) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "http://devplatform.streamingmediahosting.com/apps/sn/v1.0/dev.php?action=store_facebook_authorization&pid=" . $pid . "&ks=" . $ks . "&code=" . $code);
