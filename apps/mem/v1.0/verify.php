...
function activate_account($pid, $sm_ak, $akey, $email) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://mediaplatform.streamingmediahosting.com/apps/mem/v1.0/index.php?action=activate_account&pid=" . $pid . "&sm_ak=" . $sm_ak . "&akey=" . $akey . "&tz=America/Los_Angeles&email=" . $email);
